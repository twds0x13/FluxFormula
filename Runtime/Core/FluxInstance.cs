...
namespace FluxFormula.Core
{
    ...
    /// </summary>
    public struct FluxInstance<TData, TOper, TProvider>
        ...
        where TProvider : struct, IFluxJITDefinition<TData, TOper>
    {
        ...
        private readonly FluxJITCompiler<TData, TOper, TProvider>.CompiledFunc _jitFunc;
        ...
        internal FluxInstance(
            ...
            FluxJITCompiler<TData, TOper, TProvider>.CompiledFunc jitFunc,
            bool isJit)
        {
            _provider = provider;
            _formula = formula;
        ...
        public FluxInstance<TData, TOper, TProvider> Inject(int index, TData value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FluxInstance<TData, TOper, TProvider> InjectNext(TData value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FluxInstance<TData, TOper, TProvider> Seek(int index)
        {
        ...
        public readonly TData Run()
        {
            ...
            else
            {
                ...
                var kernel = new FluxEvaluator<TData, TOper, TProvider>(_provider);
                return kernel.Compute(_formula.GetInstructions());
            }
        }
    }
}