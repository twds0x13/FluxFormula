...
namespace FluxFormula.LiteralScanner.Generator
{
    ...
    /// 生成代码注入到 internal static partial class LiteralScanners。
    /// </summary>
    internal static class CodeEmitter
    {
            ...
            Dictionary<string, List<(string MemberName, string Tag)>>? enumTagMap = null)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace FluxFormula.Core");
            sb.AppendLine("{");
            sb.AppendLine("    partial class LiteralScanners");
            sb.AppendLine("    {");

            if (structs.Count > 0)
            {
                sb.AppendLine("        static LiteralScanners()");
                sb.AppendLine("        {");
