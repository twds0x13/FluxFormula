              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "暴击多世界线模拟", link: "/examples/damage-multiverse" },
              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    { text: "JIT 注入器", link: "/technical/pipeline/jit-injector" },
                    { text: "柯里化求值器", link: "/technical/pipeline/curry-evaluator" },
                    { text: "字面量扫描器 SG", link: "/technical/pipeline/literal-scanner-sg" },
                  ],
                },
                {
                  text: "架构与设计",
                  ...
                  items: [
                    ...
                    { text: "Blob 注册表", link: "/technical/blob-registry" },
                    { text: "VFF 格式", link: "/technical/vff-format" },
                  ],
                },
              ],
            },
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Crit Multiverse Simulation", link: "/en/examples/damage-multiverse" },
              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    { text: "JIT Injector", link: "/en/technical/pipeline/jit-injector" },
                    { text: "Curry Evaluator", link: "/en/technical/pipeline/curry-evaluator" },
                    { text: "Literal Scanner SG", link: "/en/technical/pipeline/literal-scanner-sg" },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Blob Registry", link: "/en/technical/blob-registry" },
                    { text: "VFF Format", link: "/en/technical/vff-format" },
                  ],
                },
              ],
            },
